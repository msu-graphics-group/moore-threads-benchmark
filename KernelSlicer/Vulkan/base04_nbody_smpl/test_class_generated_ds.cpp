...
void nBody_Generated::AllocateAllDescriptorSets()
{
  // allocate pool
  //
  ...
  layouts[0] = GenerateBodiesDSLayout;
  layouts[1] = copyKernelFloatDSLayout;
...
VkDescriptorSetLayout nBody_Generated::CreateUpdateVelocityDSLayout()
{
  std::array<VkDescriptorSetLayoutBinding, 1+1> dsBindings;
...
VkDescriptorSetLayout nBody_Generated::CreateUpdatePositionDSLayout()
{
  std::array<VkDescriptorSetLayoutBinding, 1+1> dsBindings;
...
VkDescriptorSetLayout nBody_Generated::CreatecopyKernelFloatDSLayout()
{
...
VkDescriptorSetLayout nBody_Generated::CreatematMulTransposeDSLayout()
{
...
void nBody_Generated::UpdateAllGeneratedDescriptorSets_perform()
{
  // now create actual bindings
  //
  // descriptor set #0: GenerateBodiesCmd (["m_bodies"])
  {
    ...
    descriptorBufferInfo[0].buffer = m_vdata.m_bodiesBuffer;
    descriptorBufferInfo[0].offset = m_vdata.m_bodiesOffset;
  ...
  // descriptor set #1: copyKernelFloatCmd (["out_bodies","m_bodies.data()"])
  {
    ...
    descriptorBufferInfo[0]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[0].buffer = perform_local.out_bodiesBuffer;
    descriptorBufferInfo[0].offset = perform_local.out_bodiesOffset;
    descriptorBufferInfo[0].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[0]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[0].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[1]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[1].buffer = m_vdata.m_bodiesBuffer;
    descriptorBufferInfo[1].offset = m_vdata.m_bodiesOffset;
    descriptorBufferInfo[1].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[1]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[1].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
