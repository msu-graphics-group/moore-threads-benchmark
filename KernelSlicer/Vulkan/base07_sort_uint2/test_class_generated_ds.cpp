...
void Sorter_Generated::AllocateAllDescriptorSets()
{
  // allocate pool
  //
  ...
  layouts[0] = CopyDataDSLayout;
  layouts[1] = m_sort_uvec2.sortDSLayout;
...
VkDescriptorSetLayout Sorter_Generated::CreateCopyDataDSLayout()
{
...
VkDescriptorSetLayout Sorter_Generated::CreatecopyKernelFloatDSLayout()
{
...
VkDescriptorSetLayout Sorter_Generated::CreatematMulTransposeDSLayout()
{
...
void Sorter_Generated::UpdateAllGeneratedDescriptorSets_Sort()
{
  // now create actual bindings
  //
  // descriptor set #0: CopyDataCmd (["a_data","a_outExc"])
  {
    ...
    descriptorBufferInfo[0].buffer = Sort_local.a_dataBuffer;
    descriptorBufferInfo[0].offset = Sort_local.a_dataOffset;
    ...
    descriptorBufferInfo[1].buffer = Sort_local.a_outExcBuffer;
    descriptorBufferInfo[1].offset = Sort_local.a_outExcOffset;
  ...
  // descriptor set #1: m_sort_uvec2.sortCmd (["a_outExc"])
  {
    ...
    descriptorBufferInfo[0]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[0].buffer = Sort_local.a_outExcBuffer;
    descriptorBufferInfo[0].offset = Sort_local.a_outExcOffset;
    descriptorBufferInfo[0].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[0]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[0].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
