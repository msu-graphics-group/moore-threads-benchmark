...
public:
  ...
  virtual void SetVulkanInOutFor_AppendTest(
  ...
  {
    AppendTest_local.a_dataBuffer = a_dataBuffer;
    AppendTest_local.a_dataOffset = a_dataOffset;
    AppendTest_local.a_outExcBuffer = a_outExcBuffer;
    AppendTest_local.a_outExcOffset = a_outExcOffset;
    UpdateAllGeneratedDescriptorSets_AppendTest();
  }
...
virtual void UpdateDeviceData(std::shared_ptr<vk_utils::ICopyEngine> a_pCopyEngine)   {
  ...
  virtual void AppendTestCmd(VkCommandBuffer a_commandBuffer, const int* a_data, unsigned int a_size, int* a_outExc);

  void AppendTest(const int* a_data, unsigned int a_size, int* a_outExc) override;

  inline vk_utils::ExecTime GetAppendTestExecutionTime() const { return m_exTimeAppendTest; }

  vk_utils::ExecTime m_exTimeAppendTest;
...
protected:
  ...
  virtual void UpdateAllGeneratedDescriptorSets_AppendTest();
  ...
  {
    VkBuffer m_valuesBuffer = VK_NULL_HANDLE;
