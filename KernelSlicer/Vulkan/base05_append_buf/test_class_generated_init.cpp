...
void PrefSummTest_Generated::DeleteDeviceData()
{
  ...
  vkDestroyBuffer(m_device, m_vdata.m_valuesBuffer, nullptr);
...
void PrefSummTest_Generated::InitDeviceData()
{
  ...
  m_vdata.m_valuesBuffer = vk_utils::createBuffer(m_device, m_values.capacity()*sizeof(int), VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT);
  memberVectors.push_back(m_vdata.m_valuesBuffer);
