...
int main(int argc, const char** argv)
{
  ...
  {
    w = args.getOptionValue<int>("-size");
    h = w;
  }
  ...
  if(onGPU)
  {
    uint32_t a_preferredDeviceId = args.getOptionValue<int>("-gpu_id", 0);
    auto features = Mandelbrot_Generated_ListRequiredDeviceFeatures();
    auto ctx      = vk_utils::globalContextInit(features, true, a_preferredDeviceId);
