...
struct PrefSummTest_Generated_UBO_Data
{
  uint dummy_last;
};
/////////////////////////////////////////////////////////////////////////////////////////// UBO
class PrefSummTest_Generated : public PrefSummTest
{
public:

  PrefSummTest_Generated()
  {
  }
  ...
  virtual void SetVulkanInOutFor_PrefixSumm(
    VkBuffer a_dataBuffer,
    size_t   a_dataOffset,
    VkBuffer a_outExcBuffer,
    size_t   a_outExcOffset,
    VkBuffer a_outIncBuffer,
    size_t   a_outIncOffset,
    uint32_t dummyArgument = 0)
  {
    PrefixSumm_local.a_dataBuffer = a_dataBuffer;
    PrefixSumm_local.a_dataOffset = a_dataOffset;
    PrefixSumm_local.a_outExcBuffer = a_outExcBuffer;
    PrefixSumm_local.a_outExcOffset = a_outExcOffset;
    PrefixSumm_local.a_outIncBuffer = a_outIncBuffer;
    PrefixSumm_local.a_outIncOffset = a_outIncOffset;
    UpdateAllGeneratedDescriptorSets_PrefixSumm();
  }

  virtual ~PrefSummTest_Generated();
...
virtual void UpdateDeviceData(std::shared_ptr<vk_utils::ICopyEngine> a_pCopyEngine)   {
  ...
  virtual void PrefixSummCmd(VkCommandBuffer a_commandBuffer, const int* a_data, unsigned int a_size, int* a_outExc, int* a_outInc);

  void PrefixSumm(const int* a_data, unsigned int a_size, int* a_outExc, int* a_outInc) override;

  inline vk_utils::ExecTime GetPrefixSummExecutionTime() const { return m_exTimePrefixSumm; }

  vk_utils::ExecTime m_exTimePrefixSumm;
  ...
  virtual void TestCmd(const int* a_data, unsigned int a_size);
...
protected:
  ...
  virtual void UpdateAllGeneratedDescriptorSets_PrefixSumm();
  ...
  struct PrefixSumm_Data
  {
    VkBuffer a_dataBuffer = VK_NULL_HANDLE;
    size_t   a_dataOffset = 0;
    VkBuffer a_outExcBuffer = VK_NULL_HANDLE;
    size_t   a_outExcOffset = 0;
    VkBuffer a_outIncBuffer = VK_NULL_HANDLE;
    size_t   a_outIncOffset = 0;
  ...
  VkDescriptorSetLayout TestDSLayout = VK_NULL_HANDLE;
  VkDescriptorSetLayout CreateTestDSLayout();
  virtual void InitKernel_Test(const char* a_filePath);
  ...
  PrefSummTest_Generated_UBO_Data m_uboData;
