...
void PrefSummTest_Generated::AllocateAllDescriptorSets()
{
  ...
  buffersSize.descriptorCount = 7 + 64 ; //
  ...
  layouts[1] = m_scan_int.internalDSLayout;
  layouts[2] = m_scan_int.internalDSLayout;
...
void PrefSummTest_Generated::UpdateAllGeneratedDescriptorSets_PrefixSumm()
{
  // now create actual bindings
  //
  // descriptor set #0: TestCmd (["a_data"])
  {
    ...
    descriptorBufferInfo[0].buffer = PrefixSumm_local.a_dataBuffer;
    descriptorBufferInfo[0].offset = PrefixSumm_local.a_dataOffset;
  ...
  // descriptor set #1: m_scan_int.internalCmd (["a_data","a_outExc","m_scan_int.m_scanTempData"])
  {
    ...
    descriptorBufferInfo[1]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[1].buffer = PrefixSumm_local.a_outExcBuffer;
    descriptorBufferInfo[1].offset = PrefixSumm_local.a_outExcOffset;
    descriptorBufferInfo[1].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[1]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[1].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[2].buffer = m_scan_int.m_scanTempDataBuffer;
    descriptorBufferInfo[2].offset = m_scan_int.m_scanTempDataOffset;
  ...
  // descriptor set #2: m_scan_int.internalCmd (["a_data","a_outInc","m_scan_int.m_scanTempData"])
  {
    constexpr uint additionalSize = 0;
    ...
    descriptorBufferInfo[1]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[1].buffer = PrefixSumm_local.a_outIncBuffer;
    descriptorBufferInfo[1].offset = PrefixSumm_local.a_outIncOffset;
    descriptorBufferInfo[1].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[1]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[1].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
