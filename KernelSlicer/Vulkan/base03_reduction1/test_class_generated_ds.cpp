...
void Numbers_Generated::AllocateAllDescriptorSets()
{
  // allocate pool
  //
  ...
  buffersSize.descriptorCount = 5 + 64 ; //
...
VkDescriptorSetLayout Numbers_Generated::CreateArraySummDSLayout()
{
...
VkDescriptorSetLayout Numbers_Generated::CreatecopyKernelFloatDSLayout()
{
...
VkDescriptorSetLayout Numbers_Generated::CreatematMulTransposeDSLayout()
{
...
void Numbers_Generated::UpdateAllGeneratedDescriptorSets_CalcArraySumm()
{
  // now create actual bindings
  //
  // descriptor set #0: ArraySummCmd (["a_data","tmpred04","tmpred14","tmpred24","tmpred34"])
  {
    ...
    descriptorBufferInfo[0].buffer = CalcArraySumm_local.a_dataBuffer;
    descriptorBufferInfo[0].offset = CalcArraySumm_local.a_dataOffset;
    ...
    descriptorBufferInfo[1].buffer = m_vdata.tmpred04Buffer;
    descriptorBufferInfo[1].offset = m_vdata.tmpred04Offset;
    ...
    descriptorBufferInfo[2].buffer = m_vdata.tmpred14Buffer;
    descriptorBufferInfo[2].offset = m_vdata.tmpred14Offset;
    ...
    descriptorBufferInfo[3].buffer = m_vdata.tmpred24Buffer;
    descriptorBufferInfo[3].offset = m_vdata.tmpred24Offset;
    ...
    descriptorBufferInfo[4].buffer = m_vdata.tmpred34Buffer;
    descriptorBufferInfo[4].offset = m_vdata.tmpred34Offset;
