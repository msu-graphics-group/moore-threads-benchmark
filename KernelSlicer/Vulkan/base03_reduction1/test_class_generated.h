...
struct Numbers_Generated_UBO_Data
{
  ...
  uint tmpred04_size;
  uint tmpred14_capacity;
  uint tmpred14_size;
  uint tmpred24_capacity;
  uint tmpred24_size;
  uint tmpred34_capacity;
  uint tmpred34_size;
  uint dummy_last;
};
/////////////////////////////////////////////////////////////////////////////////////////// UBO
class Numbers_Generated : public Numbers
{
public:
  ...
  {
    CalcArraySumm_local.a_dataBuffer = a_dataBuffer;
    CalcArraySumm_local.a_dataOffset = a_dataOffset;
    UpdateAllGeneratedDescriptorSets_CalcArraySumm();
  }

  virtual ~Numbers_Generated();
...
virtual void UpdateDeviceData(std::shared_ptr<vk_utils::ICopyEngine> a_pCopyEngine)   {
  ...
  virtual void CalcArraySummCmd(VkCommandBuffer a_commandBuffer, const float* a_data, unsigned int a_dataSize1);

  void CalcArraySumm(const float* a_data, unsigned int a_dataSize1) override;
  ...
  virtual void ArraySummCmd(const float* a_data, unsigned int a_dataSize);
...
protected:
  ...
  struct MembersDataGPU
  {
    ...
    VkBuffer tmpred14Buffer = VK_NULL_HANDLE;
    size_t   tmpred14Offset = 0;
    VkBuffer tmpred24Buffer = VK_NULL_HANDLE;
    size_t   tmpred24Offset = 0;
    VkBuffer tmpred34Buffer = VK_NULL_HANDLE;
    size_t   tmpred34Offset = 0;
  } m_vdata;
  ...
  Numbers_Generated_UBO_Data m_uboData;
